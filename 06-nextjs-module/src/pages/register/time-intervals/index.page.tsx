            ...
            fields.map((field, index) => {
              return (
                <IntervalItem key={field.id}>
                  ...
                  <IntervalInputs>
                    <TextInput size={'sm'} type={'time'} step={60} disabled={intervals[index].enabled !== true} {...register(`intervals.${index}.startTime`)} />
                    <TextInput size={'sm'} type={'time'} step={60} disabled={intervals[index].enabled !== true} {...register(`intervals.${index}.endTime`)} />
                  </IntervalInputs>
                </IntervalItem>
              )
            })

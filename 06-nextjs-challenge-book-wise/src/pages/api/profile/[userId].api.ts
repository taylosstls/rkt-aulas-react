...
export default async function handler(
  ...
  // Faz uma listagem do total de páginas de todos os livros lidos pelo usuário
  const readPages =
  ...
  // Filtra todas as categorias internas de cada livro
  ...
  const profileData = {
    ...
    readPages,
    ratedBooks,
    readAuthors: readAuthors?.length ?? 0,
    mostReadCategory,
  }
